...
const CalendarDayView = () => {
  ...
  const hours = [...Array(25)].map((_, i) => setHours(date, i));

  return (
    <div className="flex relative pt-2 pr-4 h-full">
      <TimeTable />
...
const CalendarWeekView = () => {
  ...
  const weekDates = useMemo(() => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      const hours = [...Array(25)].map((_, i) => setHours(day, i));
  ...
  return (
    <div className="flex flex-col relative overflow-auto h-full  ">
      ...
      <div className="flex flex-1">
        ...
        <div className="grid grid-cols-7 flex-1 pr-4">
...
const CalendarMonthView = () => {
  ...
  return (
    <div className="h-full flex flex-col px-4">
      ...
      <div className="grid overflow-hidden  h-full -mt-px  auto-rows-fr p-px grid-cols-7 gap-px">
...
const CalendarYearView = () => {
  ...
  const weekDays = useMemo(() => generateWeekdaysForYears(locale), [locale]);

  if (view !== "year") return null;

  return (
    <div className="grid grid-cols-4 px-4 text-center gap-8 overflow-auto h-full">
      {months.map((days, i) => (
...
const generateWeekdaysForYears = (locale: Locale) => {
  const daysOfWeek = [];
  for (let i = 0; i < 7; i++) {
    const date = addDays(startOfWeek(new Date(), { weekStartsOn: 0 }), i);
